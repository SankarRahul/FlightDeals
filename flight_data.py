class FlightData:
    ...
    def __init__(self, price, origin_airport, destination_airport, dep_date, return_date):
        """
        ...
        - dep_date: The departure date for the flight.
...
def find_cheapest_flight(data):
    """
    Parses flight data received from Amadeus API to identify cheapest flight
    """
